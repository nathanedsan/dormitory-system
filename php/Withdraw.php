...
if (isset($_SESSION["loggedinStd"]) == null||isset($_GET["confirm"])==null) {
    unset($_GET["confirm"]);
...
$sql = "SELECT * FROM `apply_record` WHERE `Std_ID`='$ID' and `AR_Type`='2';";
...
if (mysqli_num_rows($result) == 1 ) {    
    ...
    $sql = "INSERT INTO `apply_record`( `AR_Acdm_Year`, `AR_Semester`, `AR_Date`, `AR_Result`, `AR_Status`, `AR_Type`, `Std_ID`) VALUES ('$year','$AR_Semester','$today','未審核','受理中','2','$ID')";
