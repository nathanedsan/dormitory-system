                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="d-flex no-block align-items-center">
                          <div>
                            <div class="icon">
                              <h2 class="counter text-primary"><i class="lni-apartment"></i>學生第一宿舍</h2>
                              <p class="text-muted">&emsp;學生第一宿舍(學一)為高雄大學最悠久的宿舍。<br>&emsp;有公用廚房、帶鋼琴的休息區和台球桌等設施。</p>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="d-flex no-block align-items-center justify-content-center">
                          <div class="ml-auto">
                            <div style="max-width: 100%;">
                              <img src="../image/學1.png" style="width: 100%; height:200px;" onclick="openModal(this.src)">
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="d-flex no-block align-items-center">
                          <div class="ml-auto">
                            <div style="max-width: 100%;">
                              <img src="../image/學1-room.png" style="width: 100%; height:200px;" onclick="openModal(this.src)">
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="d-flex no-block align-items-center">
                          <div class="ml-auto">
                            <div style="max-width: 100%;">
                              <img src="../image/學1-kitchen.png" style="width: 100%; height:200px;" onclick="openModal(this.src)">
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="d-flex no-block align-items-center">
                          <div>
                            <div class="icon">
                              <h2 class="counter text-primary"><i class="lni-apartment"></i>學生第二宿舍</h2>
                              <p class="text-muted">&emsp;學生第二宿舍規模最大，同時在所有宿舍中有著最新的設備。<br>&emsp;有公共廚房、陽台和2間書房等設施。</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="d-flex no-block align-items-center justify-content-center">
                          <div class="ml-auto">
                            <div style="max-width: 100%;">
                              <img src="../image/學2.png" style="width: 100%; height:200px;" onclick="openModal(this.src)">
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="d-flex no-block align-items-center">
                          <div class="ml-auto">
                            <div style="max-width: 100%;">
                              <img src="../image/學2-room.png" style="width: 100%; height:200px;" onclick="openModal(this.src)">
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="d-flex no-block align-items-center">
                          <div class="ml-auto">
                            <div style="max-width: 100%;">
                              <img src="../image/學2-balcony.png" style="width: 100%; height:200px;" onclick="openModal(this.src)">
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="d-flex no-block align-items-center">
                          <div>
                            <div class="icon">
                              <h2 class="counter text-primary"><i class="lni-apartment"></i>綜合宿舍</h2>
                              <p class="text-muted">&emsp;綜合宿舍規模最小且僅供男性入住，所有設備已在109年進行更新。<br>&emsp;有洗衣房、社交廳（有電視、台球桌、飲水機、日報）和自習室等設施。</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="d-flex no-block align-items-center justify-content-center">
                          <div class="ml-auto">
                            <div style="max-width: 100%;">
                              <img src="../image/綜合.png" style="width: 100%; height:200px;" onclick="openModal(this.src)">
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="d-flex no-block align-items-center">
                          <div class="ml-auto">
                            <div style="max-width: 100%;">
                              <img src="../image/綜合-room.png" style="width: 100%; height:200px;" onclick="openModal(this.src)">
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="d-flex no-block align-items-center">
                          <div class="ml-auto">
                            <div style="max-width: 100%;">
                              <img src="../image/綜合-stdroom.png" style="width: 100%; height:200px;" onclick="openModal(this.src)">
                            </div>
                          </div>
                        </div>
                      </div>
